...
namespace Common.Data
{
    ...
    abstract public class DataRow : DObject, IHistory
    {
        ...
        public virtual int Repaire(Data.DataBaseStructure db)
        {
            return 0;
        }
        ...
        public static int DpId = Register<DataRow, long>("Id"); public long Id
        {
            get => get<long>(DpId);
            set => set(DpId, value);
        }
        ...
        public virtual string TableName => DataBaseStructure.GetPlur(GetType().Name);
        ...
        public static bool CreateColumn(DProperty property, DataBaseStructure database, DataTable table)
        {
        ...
        private static string GetInsert(Type type, string tableName)
        {
            ...
            if (!heads.TryGetValue(type, out h))
                heads.Add(type, h = new TypeDBInfo() { Name = tableName ?? DataBaseStructure.GetPlur(type.Name) });
            else if (h.Insert != null)
                return h.Insert;
            if (h.Name == null) h.Name = tableName ?? DataBaseStructure.GetPlur(type.Name);
        ...
        public static bool TryParse(string rp, out long g)
        {
