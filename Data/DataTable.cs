...
using System.Text;
using Database = Common.Data.DataBaseStructure;
using System.Data;
using Common.Utils;
...
namespace Common.Data
{
    ...
    abstract public class DataTable : DObject, IEnumerable
    {
        ...
        internal void Read(DataBaseStructure d, SqlDataReader sqlDataReader)
        {
        ...
        private DateTime UpdateLastAccess(RequestArgs args)
        {
            ...
            args.User.SetCookie(Name + "_lasttimeupdated", DateTime.Now, args.Server.ExpiredTime);
            return s;
        }
        ...
        private DateTime getDateFromRaw(RequestArgs args)
        {
            ...
            var t = args.User.GetCookie(Name + "_lasttimeupdated", false);
            if (t is DateTime)
                return (DateTime)t;
            else
    ...
    abstract public class DataTable<T> : DataTable, ISerializable where T : DataRow, new()
    {
        ...
        public new static int __LOAD__(int dp) => DObject.__LOAD__(DPOwner);
